...
import { ControllerClass, ControllerFactory } from '@loopback/rest/dist/router/controller-route';
import { ExternalExpressRoutes } from '@loopback/rest/dist/router/external-express-routes';
import { RestRouter } from '@loopback/rest/dist/router/rest-router';
import { ResolvedRoute, RouteEntry } from '@loopback/rest/dist/router/route-entry';
/**
 * Routing table
 */
